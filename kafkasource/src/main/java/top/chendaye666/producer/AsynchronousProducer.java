...
//            Thread.sleep(1000); // 1s 一条
            ...
            producer.send(new ProducerRecord<String, String>("ods_ncddzt_test", template));
...
//            System.out.println(value);
            producer.send(new ProducerRecord<String, String>("ods_ncddzt_test", value), new Callback() {
                @Override
