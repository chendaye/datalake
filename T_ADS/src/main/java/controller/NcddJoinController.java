...
public class NcddJoinController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<CommonTableEntity> ncddoiw2StreamWatermarks = ncddoiw2Stream.assignTimestampsAndWatermarks(WatermarkStrategy.<CommonTableEntity>
        ...
        SingleOutputStreamOperator<CommonTableEntity> ncddoiwStreamWatermarks = ncddoiwStream.assignTimestampsAndWatermarks(WatermarkStrategy.<CommonTableEntity>
                forBoundedOutOfOrderness(Duration.ofSeconds(3))
                .withTimestampAssigner(new SerializableTimestampAssigner<CommonTableEntity>() {
                    @Override
                    public long extractTimestamp(CommonTableEntity commonTableEntity, long l) {
